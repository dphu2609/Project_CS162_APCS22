...
public: 
    ...
    DisplayNode(int val, sf::Font &font, double size, std::string label, double labelSize, sf::Vector2f pos, sf::Color numColor, sf::Color boxColor, sf::Color boxOutlineColor);
